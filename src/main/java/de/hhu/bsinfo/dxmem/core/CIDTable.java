...
public final class CIDTable implements Importable, Exportable {
     ...
     *
     * @param p_chunkID Chunk id to translate
     * @param p_entry   Reference to CIDTableChunkEntry object to write results to
     */
     ...
     *
     * @param p_chunkID Chunk id to insert at
     * @param p_entry   Entry to insert
     ...
     *
     * @param p_entry Entry to re-read
     */
     ...
     *
     * @param p_entry Entry to flag as free
     */
     ...
     *
     * @param p_entry Entry to flag as zombie
     */
     ...
     *
     * @param p_nodeId Node id of the remote to get the data from
     * @return the ChunkID ranges
     */
     ...
     *
     * @param p_entry        Reference to write results to
     * @param p_chunkAddress Address of pinned chunk
     ...
     *
     * @param p_nodeId     Node id of table to start searching in
     * @param p_ringBuffer Ring buffer to write found zombies to
     * @param p_offset     Offset in ring buffer where to start
     ...
     *
     * @param p_tableEntries  Reference to ArrayList to return found table entries to
     * @param p_chunkEntries  Reference to ArrayList to return found chunk entries to
     * @param p_zombieEntries Reference to ArrayList to return found zombie entries to
     */
     ...
     *
     * @param p_entry Table entry to search
     ...
     *
     * @param p_addressTable Address of table to iterate
     * @param p_level        Current table level
     * @param p_cid          Current cid
     * @param p_currentCount Zombies found so far by child calls
     * @param p_ringBuffer   Reference to ring buffer to write zombies to
     * @param p_offset       Offset in ring buffer where to start writing to
     * @param p_maxCount     Max number of zombies to get
     ...
     *
     * @param p_entry Reference to table entry to write results to
     */
     ...
     *
     * @param p_entry Reference to table entry to write results to
     * @param p_level Table level to create
     ...
     *
     * @param p_address Start address to align to 64-bit bounds
     ...
     *
     * @param p_addressTable Base address of table
     * @param p_index        Index into table
     ...
     *
     * @param p_entry        Reference to entry to write results to
     * @param p_cid          Current cid
     * @param p_addressTable Address of current table
     * @param p_level        Current level of table
